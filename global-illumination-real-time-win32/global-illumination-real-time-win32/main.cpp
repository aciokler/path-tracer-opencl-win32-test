...
void initScene(Sphere* cpu_spheres) {
	...
	cpu_spheres[7].material = 0;

	// middle sphere
	cpu_spheres[8].radius = 0.16f;
	cpu_spheres[8].position = float3(-0.10f, -0.24f, 0.25f);
	cpu_spheres[8].color = float3(0.1f, 0.9f, 0.1f);
	cpu_spheres[8].emission = float3(0.0f, 0.0f, 0.0f);
	cpu_spheres[8].material = 1;

	// lightsource
	cpu_spheres[9].radius = 1.0f;
	cpu_spheres[9].position = float3(0.0f, 1.36f, 0.0f);
	cpu_spheres[9].color = float3(0.0f, 0.0f, 0.0f);
	cpu_spheres[9].emission = float3(9.0f, 8.0f, 6.0f);
	cpu_spheres[9].material = 0;
...
void render() {
	...
	cpu_spheres[6].position.s[1] += 0.24*sin(framenumber);
